...
`,
  footer: `
<footer id="footer" class="container-fluid pt-4 pb-2 text-center">
  <div
    class="container col-md-6 col-sm-8 col-10 d-flex justify-content-evenly my-4"
  >
    <div class="d-flex flex-column">
      <h2 class="fs-6">Zoznam stránok:</h2>
      <ul id="odkazyFooter" class="list-unstyled"></ul>
    </div>
    <div class="d-flex flex-column">
      <h2 class="fs-6">Zdroje obrázkov:</h2>
      <a
    ...
    <p class="align-self-center">
      <b>Vytvoril:</b> Kevin Svitač
      <br />

      <!-- kreatívny bod -->
      <i>&copy; <span id="aktualnyRok"></span></i>
    </p>
  </div>
</footer>
`,
